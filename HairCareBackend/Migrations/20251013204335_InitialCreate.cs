    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Aaron", "ClonesAreCool" },
                    { 2, "Julia", "AaronsHot" }
                });

            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "Id", "AppointmentId", "Price", "Type" },
                values: new object[,]
                {
                    { 1, null, 1m, "Haircut" },
                    { 2, null, 2m, "Coloring" },
                    { 3, null, 3m, "Beard Trim" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1 });
